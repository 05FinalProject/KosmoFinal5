			...
			<div class="card form1">
				<div class="col-md-6 form2">
					<div class="card card-primary">
						<!-- form start -->
						<form action="/admin/update" method="post" class="form3">
							<input type="hidden" name="agencyNum"
								value="${hospital.agencyNum}">
							<div class="row">
								...
								<div class="mb-3 col-md-6">
									...
									<input type="text" class="form-control"
										id="exampleFormControlInput1" name="facility">
								</div>
								...
								<div class="mb-3 col-md-12">
									...
									<input type="text" id="sample6_postcode" placeholder="우편번호"
										...
										class="btn btn-block btn-secondary"><br> <input
