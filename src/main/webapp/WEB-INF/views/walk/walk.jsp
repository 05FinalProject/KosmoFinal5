...
<script
	src="/js/jquery.min.js?ver=3.6.0"></script>
</head> 
<body>
	...
	<input id="walk-path-lon" value="" />
	<input id="walk-path-lat" value="" />
	<input id="walk-time" value="" />
	<div class="walkTimer">
		<div id="box" class="box">
			<div id="timerBox" class="timerBox">이포넷
	...
	<script>
      ...
      $("#startbtn").click(function name(params) {
        if (navigator.geolocation) {
          $("#walk-path-lon").val("");
          $("#walk-path-lat").val("");
          $("#walk-time").val("");
      ...
      function mylotation(lat, lon) {
        ...
        if (standardPosition == null) {
          ...
          console.log("sta" + standardPosition);
        } else {
          console.log("dddd");
          console.log("확인1" + standardPosition.La);
          console.log("확인2" + standardPosition.Ma);
          const dis = distance(
            standardPosition.Ma,
            standardPosition.La,
            lat,
