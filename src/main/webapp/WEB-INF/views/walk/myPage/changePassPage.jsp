          ...
          <div class="row justify-content-center">
            <div class="col-md-12">
              <div class="form-block">
                ...
                <form id="pwChangeForm" action="pwChange" method="post" name="pwChangeForm">

                <!-- DB PW -->
                  <div class="form-group first field--not-empty">
                    <label for="nowPass">현재 비밀번호&nbsp; &nbsp; &nbsp; &nbsp;<span class="error_box"></span></label>
                ...
                <!-- PW -->
                 ...
                 <!-- PW CHECK -->
                  ...
                  <!-- BTN PW CHANGE -->              
                  <input type="button" id="btnPwChange" value="비밀번호 재설정" class="pbtn btn-pill text-white btn-block btn-orange">
