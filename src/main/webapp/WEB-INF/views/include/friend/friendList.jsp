			...
			<div class="btn-group-group">
				<div class="btn-group">
					<a href="" class="btn btn-">
						<i class="fa-solid fa-user"></i> 친구채팅 <i class="fa-solid fa-angle-right" style="color:#f8b03a"></i>
					</a>
					<a href="" class="btn">
						<i class="fa-solid fa-users"></i> 그룹채팅 <i class="fa-solid fa-angle-right" style="color:#f8b03a"></i>
					</a>
				</div>
			</div>
