...
<!--  Section End -->
	...
	for (var i = 0; i < positions.length; i ++) {
	    ...
	    var iwContent = '<c:forEach var="vo" items="${paging}"><div style="padding:5px;">${vo.agencyName}</div></c:forEach>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
