	...
	public void setFile1(MultipartFile file1) {
		...
		if(!file1.isEmpty()) {
			name1 = file1.getOriginalFilename();
	         ...
	         File file = new File("C:\\FinalProject\\KosmoFinal5\\src\\main\\resources\\static\\imgFile\\" + rname1);
	...
	public void setFile2(MultipartFile file2) {
		...
		if(!file2.isEmpty()) {
			name2 = file2.getOriginalFilename();
	         ...
	         File file = new File("C:\\FinalProject\\KosmoFinal5\\src\\main\\resources\\static\\imgFile\\" + rname2);
	...
	public void setFile3(MultipartFile file3) {
		...
		if(!file3.isEmpty()) {
			name3 = file3.getOriginalFilename();
	         ...
	         File file = new File("C:\\FinalProject\\KosmoFinal5\\src\\main\\resources\\static\\imgFile\\" + rname3);
